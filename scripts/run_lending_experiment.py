...
if __name__ == '__main__':
    ...
    vars(args).pop('device', None)

    update_dict(custom_cfgs, {
        'env_cfgs': {
            'alpha1': 0.0, 'alpha2': 0.01, # 0.01 # 0.0
            'beta1': 0.0, 'beta2': 0.05,   # 0.05 # 0.0
            'rate1': [0.0, 0.2, 0.3, 0.3, 0.2,], # 0.0, 0.2, 0.3, 0.3, 0.2, # 0.0, 0.2, 0.35, 0.25, 0.2,
            'rate2': [0.0, 0.2, 0.3, 0.3, 0.2,]  # 0.0, 0.2, 0.3, 0.3, 0.2, # 0.0, 0.2, 0.25, 0.35, 0.2,
        }
    })
