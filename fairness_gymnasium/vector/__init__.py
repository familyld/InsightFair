...
# ==============================================================================
"""The vectorized Fairness-Gymnasium wrapper."""
...
import sys
sys.path.append('../../')
from fairness_gymnasium.utils.registration import make as fairness_make
from fairness_gymnasium.vector.async_vector_env import FairnessAsyncVectorEnv
from fairness_gymnasium.vector.sync_vector_env import FairnessSyncVectorEnv


__all__ = ['FairnessAsyncVectorEnv', 'FairnessSyncVectorEnv', 'VectorEnv', 'make']
...
def make(
    ...
    **kwargs,
    ...
    Example::
        ...
        >>> env = fairness_gymnasium.vector.make('Allocation-v0', num_envs=3)
    ...
    Args:
        ...
        **kwargs: Keywords arguments applied during `fairness_gymnasium.make`
    """
    ...
    return FairnessAsyncVectorEnv(env_fns) if asynchronous else FairnessSyncVectorEnv(env_fns)
