...
from fairness_gymnasium.wrappers import FairAutoResetWrapper, FairPassiveEnvChecker, FairTimeLimit
...
def make(
    ...
    **kwargs: Any,
    ...
    if isinstance(id, EnvSpec):
        ...
        assert id in fair_registry, f'Environment {id} is not registered in fairness-gymnasium.'
